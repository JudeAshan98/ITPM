...
<body>
	<div class="container">
		...
		<div class="custom-file">
			...
			<input type="button" class="btn btn-success" id= "newFile" onclick="clearAll()" value="New *"></input>
		</div>
		<div class="col-md-auto"><div class="vl"> &nbsp  &nbsp <img src="../img/green-settings.png" style="height:40px;width:40px"></div></div>
		</div>
	...
	var output = document.getElementById("output");
	  ...
	  if (this.files && this.files[0]) {
	    ...
	    reader.addEventListener('load', function (e) {
	     ...
	     //   sessionStorage.setItem("lastname", output.textContent);
	    }
	  ...
	  $(this).siblings(".custom-file-label").addClass("selected").html(fileName);
		...
		<div>
			<button type="button" class="btn btn-primary btn-lg"
				style="padding: 15px; width: 160px; height: 100px">SVM</button>
			<button type="button" class="btn btn-primary btn-lg"
				style="padding: 15px; width: 160px; height: 100px">Inheritance</button>
			<button type="button" class="btn btn-primary btn-lg"
				style="padding: 15px; width: 160px; height: 100px">Coupling</button>
			<button type="button" class="btn btn-primary btn-lg"
