			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						NKW - No of keywords <br> NID - No of identifiers <br>
						NOP - No of operators <br> NNV - No of numerical values <br>
						NSL - No of string literals <br> CS - Complexity of a program
						statement due to its size <br>
					</div>
