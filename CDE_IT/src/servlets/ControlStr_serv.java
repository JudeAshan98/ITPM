...
//	Declaring the variables
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int tot_Ccspps = 0;
		int tot_Ccs = 0;
		Result = request.getParameter("cont_res"); // Get the uploaded file content from the index JSP
		Scanner scanner = new Scanner(Result);
		ControlData controlData = new ControlData(); 
		List<List<Comparable>> p = new ArrayList<List<Comparable>>();
		// Read the Uploaded file content line by line and Assign the values to the variables
		...
		// Return the values to Control_structures JSP file
